...
@section('page-header', "Detail Jawaban")
                ...
                <div class="row">
                    ...
                    {{-- <div class="col-md-6">
                        <div class="text-right">
                            <a class="btn btn-info btn-sm" href="{{ route('pertanyaan.edit', $answer->id) }}">
                                <i class="fas fa-pencil-alt">
                                </i>
                                Edit
                            </a>
                            <a class="btn btn-danger btn-sm" href="{{ route('pertanyaan.delete', $answer->id) }}">
